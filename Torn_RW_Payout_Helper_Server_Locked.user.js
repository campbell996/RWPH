...
(function () {
  ...
  // v1.1.320: hardened Admin server response parsing, added ngrok browser-warning bypass headers, and made Admin errors show useful response previews.
  // v1.1.320: fixed Admin button binding with panel-scoped delegated handlers, and stopped Payments Accept Warning feedback from replacing the Payments Copy Panel contents.
...
<body>
  ...
  function showMainScreen(panel) {
    ...
    async function rwphRunCalculation(calculationMode = "standard", runOptions = {}) {
      ...
      // v1.1.320: Do not run an awaited cache pre-check before opening the results tab.
