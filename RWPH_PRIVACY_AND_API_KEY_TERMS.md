...
- Removed Torn newsletter marker comments from generated raw newsletter HTML code.
- Fixed raw newsletter panel **Copy All** so it copies the full HTML source with stronger clipboard fallbacks.
