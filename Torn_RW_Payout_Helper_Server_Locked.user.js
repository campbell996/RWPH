...
<body>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;background-color:${theme.bg};border-collapse:collapse;margin:0;padding:0;">
    ...
    const barTable = `<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;">
      ${[["Member Payout", money(m.memberPayout), 100], ["Tracked", String(m.totalTrackedHits), Math.min(100, Math.max(6, m.totalTrackedHits || 0))], [removedLabel, removedValue, m.includeLeftFactionMembers ? 100 : Math.min(100, Math.max(6, m.removedLeftFactionHits || 0))], [metricLabel, m.totalWeight.toFixed(2), 74]].map((item, i) => `<tr><td style="padding:7px 8px;background-color:${i % 2 ? theme.panelB : theme.panelA};border:1px solid ${theme.line};font-family:Arial,Helvetica,sans-serif;">
