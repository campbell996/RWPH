...
- Test Newsletter keeps compact-code payout rows but restores the full results stat set for long-message testing.
- Normal Basic/Advanced newsletters keep the compact v1.1.294 summary output.
